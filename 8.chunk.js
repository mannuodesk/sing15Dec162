...
/***/ "./src/app/users/basic/tables-basic.component.ts":
/***/ function(module, exports, __webpack_require__) {
...
var TablesBasic = (function () {
    function TablesBasic(_usersService) {
    ...
    TablesBasic = __decorate([
        core_1.Component({
            ...
            template: __webpack_require__("./src/app/users/basic/tables-basic.template.html")
        }), 
        __metadata('design:paramtypes', [(typeof (_a = typeof UsersService_1.UsersService !== 'undefined' && UsersService_1.UsersService) === 'function' && _a) || Object])
    ], TablesBasic);
    return TablesBasic;
    var _a;
}());
...
/***/ "./src/app/users/basic/tables-basic.template.html":
/***/ function(module, exports) {
...
/***/ "./src/app/users/dynamic/pipes/search-pipe.ts":
/***/ function(module, exports, __webpack_require__) {
    ...
    SearchPipe.prototype.transform = function (value, args) {
        ...
        if (value) {
            return value.filter(function (person) {
                if (person.firstName) {
                    return person.firstName.search(searchText) !== -1;
                }
            });
        }
    };
...
/***/ "./src/app/users/dynamic/tables-dynamic.component.ts":
/***/ function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(jQuery) {"use strict";
var core_1 = __webpack_require__("./node_modules/@angular/core/index.js");
var tables_dynamic_data_1 = __webpack_require__("./src/app/users/dynamic/tables-dynamic.data.ts");
var UsersService_1 = __webpack_require__("./src/app/services/UsersService.ts");
var PEOPLE = [
    {
        'id': '1',
...
var TablesDynamic = (function () {
    function TablesDynamic(_usersService) {
        var _this = this;
        this._usersService = _usersService;
        this.data = [];
        this.users = [];
        ...
        this._usersService.getUsers()
            ...
            for (var i = 0; i < _this.users.length; i++) {
                _this.dateTime = new Date(_this.users[i].createdOnUTC);
                var month = _this.dateTime.getMonth();
                var tempDate = _this.months[month] + "-" + _this.dateTime.getDate().toString() + "-" + _this.dateTime.getFullYear().toString();
                _this.users[i].createdOnUTC = tempDate;
                if (_this.users[i].pictureUrl == "") {
                    _this.users[i].pictureUrl = "https://cdn2.iconfinder.com/data/icons/rcons-user/32/male-shadow-fill-circle-512.png";
                }
            }
            console.log(_this.users);
        });
    }
    TablesDynamic.prototype.getDeleteId = function (val) {
        this.deleteId = val;
    };
    TablesDynamic.prototype.deleteUser = function () {
        var _this = this;
        console.log(this.deleteId);
        this._usersService.deleteUsers(this.deleteId)
            .subscribe(function (a) {
            if (a.code == 200) {
                _this.populateUsers();
            }
    ...
    TablesDynamic.prototype.populateUsers = function () {
        var _this = this;
        this._usersService.getUsers()
            .subscribe(function (a) {
            _this.users = a.data;
            ...
            for (var i = 0; i < _this.users.length; i++) {
                _this.dateTime = new Date(_this.users[i].createdOnUTC);
                var month = _this.dateTime.getMonth() + 1;
                var tempDate = _this.dateTime.getDate().toString() + "-" + month.toString() + "-" + _this.dateTime.getFullYear().toString();
                _this.users[i].createdOnUTC = tempDate;
                if (_this.users[i].pictureUrl == "") {
                    _this.users[i].pictureUrl = "https://cdn2.iconfinder.com/data/icons/rcons-user/32/male-shadow-fill-circle-512.png";
                }
    ...
    TablesDynamic = __decorate([
        core_1.Component({
            ...
            providers: [UsersService_1.UsersService],
            template: __webpack_require__("./src/app/users/dynamic/tables-dynamic.template.html"),
            encapsulation: core_1.ViewEncapsulation.None,
            styles: [__webpack_require__("./src/app/users/dynamic/tables-dynamic.style.scss"), __webpack_require__("./src/app/ui-elements/components/modal-window/modal.style.scss")]
        }), 
        __metadata('design:paramtypes', [(typeof (_a = typeof UsersService_1.UsersService !== 'undefined' && UsersService_1.UsersService) === 'function' && _a) || Object])
    ], TablesDynamic);
...
/***/ "./src/app/users/dynamic/tables-dynamic.data.ts":
/***/ function(module, exports) {
...
/***/ "./src/app/users/dynamic/tables-dynamic.style.scss":
/***/ function(module, exports) {
...
var tables_basic_component_1 = __webpack_require__("./src/app/users/basic/tables-basic.component.ts");
var tables_dynamic_component_1 = __webpack_require__("./src/app/users/dynamic/tables-dynamic.component.ts");
var search_pipe_1 = __webpack_require__("./src/app/users/dynamic/pipes/search-pipe.ts");
exports.routes = [
    { path: '', component: tables_dynamic_component_1.TablesDynamic, pathMatch: 'full' },
];
